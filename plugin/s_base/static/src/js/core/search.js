odoo.define('s_base.MenuSearchMixin', function (require) {
    "use strict";
    ...
    var MenuSearchMixin = {
        ...
        _searchMenus: function () {
            ...
            this.$search_results.html(QWeb.render("s_base.MenuSearchResults", {
                results: results,
                widget: this,
            }));
        },
        _onSearchResultsNavigate: function (event) {
            ...
            var all = this.$search_results.find(".s_base_menu_search_result");
