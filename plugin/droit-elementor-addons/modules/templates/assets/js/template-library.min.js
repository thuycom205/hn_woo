!function($, $ele, $i) {
    ...
    $app.Manager = function() {
        ...
        function addButton() {
            ...
            }), $sl.find(".dl_templates_add_button").length || $sl.find(DROIT_FIND_SELECTOR).before($droitPpenLibraryButton)
        }

        function initAddButton($el) {
            var $t = $el.find(DROIT_FIND_SELECTOR);
            $t.length && !$el.find(".dl_templates_add_button").length && $t.before($droitPpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
        }
        ...
        $droitPpenLibraryButton = '<div class="elementor-add-section-area-button dl_templates_add_button"> <img src="'+droitEditor.templateLogo+'" /> </div>', 
        $dlResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
        ...
        this.init = function() {
            $this.setFilter("type", droitEditor.default_tab, !0), $ele.on("preview:loaded", onEditorLoaded.bind(this))
        }, 
        this.getTabs = function() {
            var e = this.getFilter("type");
            return tabs = JSON.parse(droitEditor.tab_style)
        ...
        this.requestLibraryData = function(e) {
            ...
            e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_dladdon_library_data", t)
        }, 
        this.requestTemplateData = function(e, t) {
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_dladdon_template_data", i)
        }, 
