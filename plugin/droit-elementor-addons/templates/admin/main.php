    ...
    <div class="dl_addons_row dl_flex_item_center">
      ...
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          ...
          <a href="https://droitthemes2.ticksy.com/submit/" target="_blank" class="cu_btn dl_gradient_btn btn_1 dl-btn-small "><?php esc_html_e('Support Ticket', 'droit-addons'); ?></a>
        </div>
      </div>
