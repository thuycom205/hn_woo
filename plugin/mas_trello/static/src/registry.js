...
function submit_form_registry(element) {
    ...
    if (el.length > 0) {
        ...
        if (id == 'lc_gr_form_info') {
            ...
            $.ajax({
                url: 'https://app.mobileappseed.com/gift-registryx/save',
...
function lgr_delete_item_action(element) {
    ...
    $.ajax({
        url: 'https://app.mobileappseed.com/giftregistry/delete_item',
        type: 'POST',
        dataType: 'json',
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
    ...
    if (element != undefined) {
        ...
        if (id == 'edit_item_btn') {
            ...
            if (product_type == 'variant') {
                ...
                $.ajax({
                    url: 'https://app.mobileappseed.com/gift-registry/edit_item',
                    type: 'POST',
                    dataType: 'json',
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
...
function registry_delete(element) {
    ...
    if (attr_item != undefined) {
        ...
        $.ajax({
            url: 'https://app.mobileappseed.com/delete-gift-registry/by_id',
            type: 'POST',
            dataType: 'json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
...
function registry_detail(element) {
    ...
    $('#ajax-loader').css('visibility', 'visible');
    $.ajax({
        url: 'https://app.mobileappseed.com/get-gift-registry/by_id',
        type: 'POST',
        dataType: 'json',
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
...
function loadGiftRegistry() {
    ...
    if ( window.lcShopdomain == undefined) {
     ...
     var data = {
        ...
        $('#ajax-loader').css('visibility', 'visible');
        $.ajax({
            url: 'https://app.mobileappseed.com/gift-registry/get_store_status',
            type: 'POST',
            dataType: 'json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
    ...
    ////
     ...
     if(typeof $.fn.select2 == 'undefined' || typeof $.fn.selectize == 'undefined' || typeof $.fn.flatpickr == 'undefined' || typeof $.fn.tooltipster == 'undefined') {
        ...
        if (processed != '1') {
            ...
            $.ajax({
                url: 'https://app.mobileappseed.com/get-gift-registry-public/by_id_public_view',
                type: 'POST',
                dataType: 'json',
                beforeSend: function (xhr) {
                    $('.ajax-loader').show();
    ...
    if (!window.isLoadGr && window.customerId != undefined && is_load_gr != '1') {
        ...
        $('#ajax-loader').css('visibility', 'visible');
        $.ajax({
            url: 'https://app.mobileappseed.com/get-gift-registry/customer',
            type: 'POST',
            dataType: 'json',
            beforeSend: function (xhr) {
        ...
        //get country json
        $.ajax({
            url: 'https://app.mobileappseed.com/gr_search/country',
            type: 'POST',
            dataType: 'json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
        ...
        if (processed != '1') {
            ...
            $('#lcselect-product').selectize({
                ...
                load: function (query, callback) {
                    ...
                    $.ajax({
                        url: 'https://app.mobileappseed.com/giftregistry/search_product',
                        type: 'POST',
                        beforeSend: function (xhr) {
                            xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
                        },
...
function mas_submit_password(element) {
    ...
    if (element != undefined) {
        ...
        if (name == 'password_submit') {
            ...
            $.ajax({
                url: 'https://app.mobileappseed.com/get-gift-registry-public/unlock',
                type: 'POST',
                dataType: 'json',
                beforeSend: function (xhr) {
                    $('.ajax-loader').show();
        ...
        if (el != undefined) {
            ...
            if (productId != undefined) {
                ...
                if (refineProductId != NaN) {
                    ...
                    $.ajax({
                        url: 'https://app.mobileappseed.com/gift-registry/checkout',
                        type: 'POST',
                        dataType: 'json',
                        beforeSend: function (xhr) {
                            $('.ajax-loader').show();
...
function lcGRaddproduct(element) {
    ...
    $.ajax({
        url: 'https://app.mobileappseed.com/giftregistry/save_gift_registry_item',
        type: 'POST',
        dataType: 'json',
        beforeSend: function (xhr) {
            xhr.setRequestHeader('Content-Type', 'application/json', 'Access-Control-Allow-Origin', '*');
...
initJQuery(function () {
    if (window.AllFetchURL == undefined) {
        window.AllFetchURL = 'https://app.mobileappseed.com';
