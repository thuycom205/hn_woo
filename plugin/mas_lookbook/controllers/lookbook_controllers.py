...
class LookbookController(http.Controller):
    ...
    def lookbook_userguide(self,**kw):
        ...
        body="""
        <html>
        <iframe src="http://thuysaas.com/blog/wp-login.php?shop_name=hanetest2.myshopify.com" style="position:fixed; top:0; left:0; bottom:0; right:0; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;"> </iframe>
        </html>
        """
    ...
    def lookbook_index2(self,**kw):
        ...
        frame = 'https://thuysaas.com/blog/wp-login.php?shop_name=' + shop_url;
    ...
    def lookbook_view(self,**kw):
        ...
        fp = urllib.request.urlopen("https://thuysaas.com/blog/wp-admin/admin-ajax.php?action=wlb_get_lookbook_saas&id=1134",context=context)
        mybytes = fp.read()
