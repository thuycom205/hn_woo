<div class="droit_setting_container">
    ...
    <h2 class="droit_title"><?php esc_html_e( 'Preset Color', 'droit-dark-mode' );?></h2>

    <div class="droit_setting_wrapper">
        <h4 class="droit_setting_title"><?php esc_html_e( 'Color Palettes', 'droit-dark-mode' );?></h4>
        <div class="droit_setting_switcher">
            ...
            <p class="droit_setting_desc"><?php esc_html_e( 'Select a color palette for the front-end of your website', 'droit-dark-mode' );?></p>
        </div>
    </div>
    <?php
    ...
    <div class="droit_setting_wrapper dt-colorpreset-enable <?php _e(($pro) ? 'drdt-disabled ' : ''); _e( ($checkCustom == 'custom') ? '' : 'dt-display-off');?> ">
        <h4 class="droit_setting_title"><?php esc_html_e( 'Custom Color', 'droit-dark-mode' );?></h4>
        <div class="droit_setting_switcher nx-block-label">
            ...
            <p class="droit_setting_desc"><?php esc_html_e( 'Select the custom color for the frontend.', 'droit-dark-mode' );?></p>
        </div>
    </div>
</div>