                    ...
                    <div class="sticky_sldebar">
                        ...
                        <div class="tab-menu tab_left_content">
                                ...
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"><?php esc_html_e( 'Active License', 'droit-dark-mode' );?></h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'Enter license key', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            ...
                            <button class="tab-menu-link active" type="button" data-content="droit_general">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"><?php esc_html_e( 'General Settings', 'droit-dark-mode' );?></h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'Basic settings for dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            <button class="tab-menu-link" type="button" data-content="droit_display">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"><?php esc_html_e( 'Display Settings', 'droit-dark-mode' );?></h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'Display settings for dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            <button class="tab-menu-link" type="button" data-content="droit_advance">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"> <?php esc_html_e( 'Advance Settings', 'droit-dark-mode' );?></h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'Advanced settings for dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            <button class="tab-menu-link" type="button" data-content="droit_preset">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"> <?php esc_html_e( 'Preset Color', 'droit-dark-mode' );?></h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'By default preset design for dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            <button class="tab-menu-link" type="button" data-content="droit_image">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"><?php esc_html_e( 'Dark Image', 'droit-dark-mode' );?></h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'Replace image when dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            <button class="tab-menu-link" type="button" data-content="droit_time">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        ...
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"><?php esc_html_e( 'Time Base', 'droit-dark-mode' );?>
                                            </h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'Set time base dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            <button class="tab-menu-link" type="button" data-content="droit_os_base">
                                <div class="dl_tab_content">
                                    <div class="tab_content_inner">
                                        <div class="droit_dark_sidebar_menu">
                                            <img src="<?php echo plugin_dir_url( __DIR__ ).'../assets/images/sidebar_icon/OS.svg'; ?>" alt="#">
                                        </div>
                                        <div class="tab_content">
                                            <h4 class="admin_tab_title"><?php esc_html_e( 'OS Base', 'droit-dark-mode' );?>
                                            </h4>
                                            <span class="admin_tab_desc"><?php esc_html_e( 'OS based dark mode', 'droit-dark-mode' );?></span>
                                        </div>
                                    </div>
                                </div>
                            </button>
                            ...
                            <a style="text-align: center; text-decoration: none;" href="https://droitthemes2.ticksy.com/submit/">
                                <h4 style="margin: 15px auto;"><?php esc_html_e( 'Get Support', 'droit-dark-mode' );?></h4>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="tab-bar">
                    <div class="setting-submit-section dt-top dt-justify dt-center">
                        <button class="setting-submit sty1" type="submit"><i class=""></i>
                            <?php esc_html_e('Save Settings', 'droit-dark-mode');?></button>
                    </div>
                    ...
                    <div class="tab-bar-content" id="droit_os_base">
                        <?php include_once( __DIR__ . '/view/os-base.php');?>
                    </div>
