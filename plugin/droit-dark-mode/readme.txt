...
Contributors: droitthemes, golaphazi, webrahaman, rafs45, rony015, mhimon
...
18. **OS-based Dark Mode** – Get dark mode instantly, Droit Dark Mode automatically detects the dark mode enabled on your OS and switches it on your website automatically. 
...
[**See our Documentation**](https://docs.droitthemes.com/droit-dark-mode/docs/)

= Pro version is out right now =

[**Checkout the feature list here **](https://droitthemes.com/droit-dark-mode/)
...
* Fix: Added Media Modal Opener for Light & Dark Image
* Fix: Added CDN (Shortpixel) Image Support for dark image replacement
* New: Added Localization file
* New: Added Menu Location for Dark Switch

= 1.0.7 - 09-12-2021 =

* Fix: Admin Dashboard Issues
* Fix: Button Issues front-end
* New: 12+ WordPress free themes compatible
