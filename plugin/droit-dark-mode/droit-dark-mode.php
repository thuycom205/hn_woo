...
add_action( 'plugins_loaded', function(){
	// load text domain
	load_plugin_textdomain( 'droit-dark-mode', false, basename( dirname( __FILE__ ) ) . '/languages'  );
    ...
    // load theme support
    \DroitDark\Includes\Dtdr_Themes::_instance()->_init();
