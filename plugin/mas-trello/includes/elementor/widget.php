...
class WOO_TRELLO_Elementor_Widget extends Widget_Base {
	...
	public function get_script_depends() {
		return [ 'jquery-slides', 'jquery-vi-flexslider', 'woocommerce-lookbook' ];
	}

	public function get_style_depends() {
		do_action( 'wlb_elementor_get_inline_style' );

		return [ 'woocommerce-vi-flexslider', 'woocommerce-lookbook' ];
	}

	public function get_name() {
		return 'woocommerce-lookbook';
	}
